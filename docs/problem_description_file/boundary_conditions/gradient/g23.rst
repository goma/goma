...
This Dirichlet boundary condition specification is used to set a constant yz-velocity
gradient component of the velocity gradient tensor. Definitions of the input parameters
are as follows:

============ ====================================================================
**G23**      Boundary condition name (<bc_name>) that defines the yz-velocity
             gradient.
...
The following is a sample card for applying a Dirichlet condition on the yz-velocity
...
.. figure:: /figures/182_goma_physics.png
	:align: center
	:width: 90%
