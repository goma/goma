...
This Dirichlet boundary condition specification is used to set a constant zx-velocity
gradient component of the velocity gradient tensor. Definitions of the input parameters
are as follows:

============ ====================================================================
**G31**      Boundary condition name (<bc_name>) that defines the zx-velocity
             gradient.
...
The following is a sample card for applying a Dirichlet condition on the zx-velocity
...
.. figure:: /figures/183_goma_physics.png
	:align: center
	:width: 90%
