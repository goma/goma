...
This Dirichlet boundary condition specification is used to set a constant zy-velocity
gradient component of the velocity gradient tensor. Definitions of the input parameters
are as follows:

============ ====================================================================
**G32**      Boundary condition name (<bc_name>) that defines the zy-velocity
             gradient.
...
The following is a sample card for applying a Dirichlet condition on the zy-velocity
...
.. figure:: /figures/184_goma_physics.png
	:align: center
	:width: 90%
