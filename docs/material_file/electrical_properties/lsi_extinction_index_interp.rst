**********************************************************
Level Set Interface Extinction Index Interpolation Method
**********************************************************

::

   Level Set Interface Extinction Index Interpolation Method = {char_string}

-----------------------
**Description / Usage**
-----------------------

This specifies the interpolation method of the level set properties for Extinction Index
...
::
   ...
   Level Set Interface Extinction Index Interpolation Method = LOG
