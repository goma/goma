*************************************************************
Level Set Interface Acoustic Absorption Interpolation Method
*************************************************************

::

   Level Set Interface Acoustic Absorption Interpolation Method = {char_string}

-----------------------
**Description / Usage**
-----------------------

This specifies the interpolation method of the level set properties for Acoustic Absorption
...
::
   ...
   Level Set Interface Acoustic Absorption Interpolation Method = LOG
