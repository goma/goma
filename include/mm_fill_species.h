...
EXTERN void mass_flux_surf_BV(dbl mass_flux[MAX_CONC],
...
EXTERN void mass_flux_surf_HOR(dbl mass_flux[MAX_CONC],
                               dbl d_mass_flux[MAX_CONC][MAX_VARIABLE_TYPES + MAX_CONC],
                               int wspec,     /* species number                          */
...
EXTERN void mass_flux_surf_ORR(dbl mass_flux[MAX_CONC],
                               dbl d_mass_flux[MAX_CONC][MAX_VARIABLE_TYPES + MAX_CONC],
                               int wspec,  /* species number                            */
                               double ai0, /* product of interfacial area by            */
                               /* exchange current density (A/cm^3)         */
...
EXTERN void mass_flux_surf_H2O_ANODE(dbl mass_flux[MAX_CONC],
                                     dbl d_mass_flux[MAX_CONC][MAX_VARIABLE_TYPES + MAX_CONC],
                                     int wspec,  /* species number                          */
                                     double ai0, /* product of interfacial area by          */
                                     /* exchange current density (A/cm^3)       */
...
EXTERN void mass_flux_surf_H2O_CATHODE(dbl mass_flux[MAX_CONC],
                                       dbl d_mass_flux[MAX_CONC][MAX_VARIABLE_TYPES + MAX_CONC],
                                       int wspec,  /* species number                           */
                                       double ai0, /* product of interfacial area by           */
                                       /* exchange current density (A/cm^3)        */
...
EXTERN void mass_flux_surf_SULFIDATION(dbl mass_flux[MAX_CONC],
                                       dbl d_mass_flux[MAX_CONC][MAX_VARIABLE_TYPES + MAX_CONC],
...
EXTERN void mass_flux_surf_user_bc(double[DIM], /*  func                                     */
                                   double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
                                   const int,      /* wspec - species number                    */
                                   const double[], /* p - parameterize species transfer model   */
                                   const dbl);     /* time  */

EXTERN void mass_flux_alloy_surf(double[DIM], /*  func                                     */
                                 double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
                                 const int,      /* wspec - species number                    */
                                 const double[], /* p - parameterize species transfer model   */
                                 const dbl);     /* time  */
...
EXTERN void mass_flux_HOR_surf_bc(double func[],
                                  double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
...
EXTERN void mass_flux_ORR_surf_bc(double func[],
                                  double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
                                  int,     /* wspec - species number of this boundary condition   */
                                  double,  /* ai0 - product of interfacial area by                */
                                           /* exchange current density (A/cm^3)                   */
...
EXTERN void
mass_flux_H2O_ANODE_surf_bc(double func[],
                            double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func           */
                            int,     /* wspec - species number of this boundary condition   */
                            double,  /* ai0 - product of interfacial area by                */
                                     /* exchange current density (A/cm^3)                   */
...
EXTERN void
mass_flux_H2O_CATHODE_surf_bc(double func[],
                              double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
                              int,     /* wspec - species number of this boundary condition   */
                              double,  /* ai0 - product of interfacial area by                */
                                       /* exchange current density (A/cm^3)                   */
...
EXTERN int ls_modulate_speciessource(int, struct Species_Conservation_Terms *);

EXTERN void fickian_charged_gradient_bc(double[],
                                        double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
