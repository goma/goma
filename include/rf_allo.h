...
#define alloc_void_struct_1(arg1,arg2) \
                       alloc_void_struct_1_FL((arg1), (arg2), __FILE__, __LINE__)
#define  alloc_struct_1(x, num)  \
               (x *) alloc_void_struct_1_FL(sizeof(x), (num), __FILE__, __LINE__)

#define zeroStructures(xptr, num) \
               zero_structure((void *)(xptr), sizeof((*xptr)), (num))
#define realloc_ptr_1(arg1, arg2, arg3)  \
                     realloc_ptr_1_FL((arg1), (arg2), (arg3), __FILE__, __LINE__)
#define realloc_int_1(arg1, arg2, arg3)  \
                     realloc_int_1_FL((arg1), (arg2), (arg3), __FILE__, __LINE__)
#define realloc_dbl_1(arg1, arg2, arg3)  \
                     realloc_dbl_1_FL((arg1), (arg2), (arg3), __FILE__, __LINE__)
#define realloc_struct_1(arg1, x, arg3, arg4)  \
                     (x *) realloc_void_struct_1_FL((arg1), sizeof(x), (arg3), (arg4),__FILE__, __LINE__)
#define alloc_int_2(arg1, arg2, arg3) \
                       alloc_int_2_FL((arg1), (arg2), (arg3), __FILE__, __LINE__)
#define alloc_dbl_2(arg1, arg2, arg3) \
                       alloc_dbl_2_FL((arg1), (arg2), (arg3), __FILE__, __LINE__)
...
extern short int  *alloc_short_1_FL(const int, const int,
				    const char *, const int);
extern double *alloc_dbl_1_FL(const int, const double, const char *, const int);
extern void *alloc_void_struct_1_FL(const size_t, const int, const char *,
				    const int); 
extern void zero_structure(void *, const size_t, const int);
extern void **alloc_ptr_1_FL(const int, const char *, const int);
extern void realloc_ptr_1_FL(void ***, const int, const int, const char *,
			     const int);
extern void ***alloc_ptr_2_FL(const int, const int, const char *, const int);
extern int **alloc_int_2_FL(const int, const int, const int, const char *,
			    const int);
extern double **alloc_dbl_2_FL(const int, const int, const double, 
                               const char *, const int);
extern char **alloc_VecFixedStrings(const int, const int);
extern char *alloc_copy_string_FL(const char *, const char *, const int);

extern void realloc_int_1_FL(int **, const int, const int, const char *,
			     const int);
extern void  realloc_dbl_1_FL(double **, const int, const int, const char *,
			     const int);
extern void *realloc_void_struct_1_FL(void *, const size_t, const int, const int, const char *,
				       const int);
