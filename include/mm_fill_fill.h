...
EXTERN int integrate_explicit_eqn(struct GomaLinearSolverData *, /* ams - cf "sl_util_structs.h"  */
...
EXTERN struct LS_Surf *closest_surf(struct LS_Surf_List *, double *, Exo_DB *, double *);
...
EXTERN struct LS_Surf *create_surf_facet_line(struct LS_Surf *, struct LS_Surf *);
...
EXTERN int
boundary_curvature(double[DIM], double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], double *);

EXTERN int
curvature_momentum_source(double[DIM], double[DIM][DIM][MDE], double[DIM][MDE], double[DIM][MDE]);

#ifdef CONST_CURVE
EXTERN int curvature_momentum_source_const(double[DIM],
                                           double[DIM][DIM][MDE],
                                           double[DIM][MDE],
                                           double[DIM][MDE]);
#endif
...
EXTERN int assemble_phase_function(double, double, double, double[DIM], Exo_DB *);

EXTERN int assemble_pf_constraint(double, double *, double, double *, double *);

EXTERN void assemble_ls_mass_lumped_penalty(struct LS_Mass_Lumped_Penalty *mass_lumped_penalty,
                                            int ip_total,
                                            int ielem_type,
                                            PG_DATA *pg_data);
