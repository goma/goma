...
EXTERN void asdv
(double **,		/* v - vector to be allocated */
...
(const int ,	/* Block row index */
       const int ,     /* Block column index */
       struct Aztec_Linear_Solver_System *) ;

EXTERN double newshape
(const double [],		/* xi - local element coordinates            */
...
(dbl *,			/* gammadot - strain rate scalar invariant   */
...
(const int ,		/* num_sides - of the elements (homogeneous) */
