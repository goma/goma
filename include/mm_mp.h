...
extern struct Variable_Initialization	Var_init[MAX_VARIABLE_TYPES + 
							 MAX_CONC];
...
extern int goma_mat_prop_init(MATRL_PROP_STRUCT *, int,
	       	              PROBLEM_DESCRIPTION_STRUCT *);
extern double calc_density(MATRL_PROP_STRUCT *, int, PROPERTYJAC_STRUCT *, double time);
extern double calc_concentration(MATRL_PROP_STRUCT *, int,
                                 PROPERTYJAC_STRUCT *);
