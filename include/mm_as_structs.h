...
struct Element_Variable_Pointers {
  ...
  dbl *lubp_3[MDE];             /* third lub pressure */
...
struct Element_Stiffness_Pointers {
  ...
  dbl **lubp_3;         /* lubp_3[MDE], second lub pressure */
...
struct Field_Variables {
  ...
  dbl grad_lubp_3[DIM];      /* Gradient of third lub pressure       */
  ...
  dbl d_grad_lubp_3_dmesh[DIM][DIM][MDE];
...
struct Lubrication_Auxiliaries {
  ...
  double q1[DIM];             /* Volumetric flow rate per unit width */
  double v_avg1[DIM];         /* Average velocity, i.e. q divided by height */
  ...
  double dgradP_mag_df; 
  /* Pressure gradient magnitude sensitivities w.r.t.
                           LEVEL SET */
  double dgradP_tangent_df[DIM]; 
  /* Pressure gradient tangent sensitivities
                                    w.r.t. LEVEL SET */
  double dgradP_normal_df[DIM]; 
  /* Pressure gradient normal sensitivities w.r.t.
                                   LEVEL SET */
  ...
  double dv_avg1_dp1[DIM][MDE]; /* Average velocity sensitivities w.r.t.
                                    lubrication pressure */
