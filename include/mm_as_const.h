...
#define V_SOLNVECTOR    0x00000001 /* This variable is solved for in the
				      solution vector */
#define V_FIXED		0x00000002 /* Variable is fixed at constant value.
				      It is assumed to be continuous across
				      material boundaries. */
#define V_SPECIFIED     0x00000004 /* Variable is not part of the solution
				      variable, but it does vary across the
				      domain. Value is calculated via interp
				      from nodal values */
#define V_MATSPECIFIC   0x00000008 /* This variable is unique to this material
...
#define I_SP		12 /* Subparametric - linear on the interior,
				      quadratic on  surfaces */
#define I_Q2_D		13 /* Lagrangian quadratic with special
                                      surface dofs  */
#define I_Q1_D		14 /* Lagrangian linear with special
                                      surface dofs  */
...
#ifndef MAX_INTERP_TYPES
#define MAX_INTERP_TYPES  45
#endif
