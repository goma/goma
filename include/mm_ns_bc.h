...
EXTERN void fvelo_normal_auto_bc(double[DIM],       /* func                                      */
                                 double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
                                 const double, /* vnormal - normal velocity                 */
                                 const int,    /* contact flag */
                                 const double[MAX_PDIM], /* x_dot - Bad name, says Phil!
...
EXTERN void fvelo_normal_lub_bc(double[DIM], /* func                                      */
                                double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func */
                                const int,                                       /* Side ID */
                                const double[MAX_PDIM], /* x_dot - Bad name, says Phil!
                                                         * -mesh velocity vector */
...
EXTERN void fvelo_tangential_bc(double[], /* func                                      */
                                ...
                                const double[MAX_PDIM], /* xsurf - coordinates of surface Gauss
...
EXTERN void apply_repulsion(double cfunc[MDE][DIM],
...
EXTERN void apply_repulsion_roll(double cfunc[MDE][DIM],
                                 double d_cfunc[MDE][DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
...
EXTERN void apply_repulsion_user(double cfunc[MDE][DIM],
                                 double d_cfunc[MDE][DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                 const double,                 /* roll radius      */
                                 const double[3],              /* axis origin      */
                                 const double[3],              /* direction angles      */
...
EXTERN void apply_repulsion_table(double cfunc[MDE][DIM],
                                  double d_cfunc[MDE][DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                  double[],                     /* Solution vector */
                                  const double,                 /* repulsion length scale      */
                                  const double,                 /* repulsion exponent     */
...
EXTERN void apply_vapor_recoil(double cfunc[MDE][DIM],
                               double d_cfunc[MDE][DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
...
EXTERN void stress_no_v_dot_gradS_sqrt(double func[MAX_MODES][6],
                                double d_func[MAX_MODES][6][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                const double dt,
                                const double tt);
...
EXTERN void PSPG_consistency_bc(double *func,
                                double d_func[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                const dbl x_dot[DIM],
...
EXTERN void fapply_CA(double *, /* func                                      */
                      double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func      */
...
EXTERN void fapply_var_CA(double *, /* func                                      */
                          double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func      */
                          double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func_ss   */
                          const double[MAX_PDIM], /* fsnormal - free surface normal components */
                          double[MAX_PDIM][MAX_PDIM][MDE], /* dfsnormal_dx - free surface
...
EXTERN void apply_wetting_velocity(double[MAX_PDIM],
...
void apply_linear_wetting_sic(double[MAX_PDIM],
                              double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                              const double,
                              const double,
                              int,
...
EXTERN void qside_contact_resis(double[DIM],                                     /* func */
                                double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /*   d_func   */
...
EXTERN double
calculate_laser_flux(const double[], double, const double[], double[], int, int, double[]);

EXTERN double calculate_vapor_cool(const double[], double *, double);
...
EXTERN void apply_sharp_wetting_velocity(double[MAX_PDIM],
                                         double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                         const int,
                                         const double,
                                         const double,
...
void apply_blake_wetting_velocity(double[MAX_PDIM],
                                  double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                  const int,
                                  int,
                                  int,
...
void apply_blake_wetting_velocity_sic(double[MAX_PDIM],
                                      double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                                      const double,
                                      const double,
                                      int,
...
void sheet_tension(double[MDE][DIM],
...
void apply_SES(double[MAX_PDIM],
               double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
               struct elem_side_bc_struct *,
               double,
               int,
...
void shear_to_shell(double[MDE][DIM],
                    double[MDE][DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE],
                    const int, /* ID of the side of the element */
                    double,
                    struct elem_side_bc_struct *,
...
void apply_hysteresis_wetting_sic(
    double *, double[MAX_PDIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], double, double, double *);

void fgamma1_deriv_bc(double[DIM], /* func                                      */
                      double[DIM][MAX_VARIABLE_TYPES + MAX_CONC][MDE], /* d_func           */
                      const double); /* vnormal - normal velocity                 */
