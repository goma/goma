...
PROTO((double [],		/* u   -- some vector of doubles */
...
PROTO((const int [],		/* ija - CMSR column pointers into matrix    */
       const double []));	/* a - Jacobian matrix                       */

extern int filter_conc		/* rf_util.c                                 */
PROTO((const int ,		/* N - number of nodes                       */
...
PROTO((const int ,              /* name of variable to be indexed            */
...
PROTO((const int ,              /* name of variable to be counted            */
       const int  ));           /* upper limit on range of nodes to be       */
                                /* searched in Dolphin array                 */
