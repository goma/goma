...
EXTERN void update_parameterC(int,       /* CONDITION NUMBER */
...
EXTERN void update_parameterTP(int,       /* CONDITION NUMBER */
                               double,    /* PARAMETER VALUE */
                               double *,  /* UNKNOWN VECTOR */
                               double *,  /* UNKNOWN_DOT VECTOR */
                               double *,  /* x_AC VECTOR */
...
EXTERN void update_parameterHC(int,       /* HC ID */
                               double,    /* PARAMETER VALUE */
                               double *,  /* UNKNOWN VECTOR */
                               double *,  /* UNKNOWN_DOT VECTOR */
                               double *,  /* x_AC VECTOR */
...
EXTERN void update_parameterS(double,    /* PARAMETER VALUE */
                              double *,  /* UNKNOWN VECTOR */
                              double *,  /* UNKNOWN_DOT VECTOR */
...
EXTERN void update_BC_parameter(double,    /* PARAMETER VALUE */
                                int,       /* BCID */
                                int,       /* DFID */
                                Comm_Ex *, /* cx  - array of communications structures */
                                Exo_DB *,  /* exo - ptr to finite element mesh database */
...
EXTERN void update_AC_parameter(double,    /* PARAMETER VALUE */
                                int,       /* BCID */
                                int,       /* DFID */
                                Comm_Ex *, /* cx  - array of communications structures */
                                Exo_DB *,  /* exo - ptr to finite element mesh database */
...
EXTERN void update_MT_parameter(double,    /* PARAMETER VALUE */
...
EXTERN void update_UM_parameter(double,    /* PARAMETER VALUE */
                                int,       /* Material number index */
                                int,       /* Material property tag */
                                int,       /* Material property tag subindex */
                                Comm_Ex *, /* cx  - array of communications structures */
...
EXTERN void retrieve_parameterS(double *,  /* PARAMETER VALUE */
                                double *,  /* UNKNOWN VECTOR */
                                double *,  /* UNKNOWN_DOT VECTOR */
                                int,       /*  type of sensitivity variable(BC or MT) */
                                int,       /*  variable id BCID or MT# */
...
EXTERN void retrieve_BC_parameter(double *,  /* PARAMETER VALUE */
                                  int,       /* BCID */
                                  int,       /* DFID */
                                  Comm_Ex *, /* cx  - array of communications structures */
                                  Exo_DB *,  /* exo - ptr to finite element mesh database */
...
EXTERN void retrieve_MT_parameter(double *,  /* PARAMETER VALUE */
                                  int,       /* Material number index */
                                  int,       /* Material property tag */
                                  Comm_Ex *, /* cx  - array of communications structures */
                                  Exo_DB *,  /* exo - ptr to finite element mesh database */
...
EXTERN void retrieve_AC_parameter(double *,  /* PARAMETER VALUE */
                                  int,       /* BCID */
                                  int,       /* DFID */
                                  Comm_Ex *, /* cx  - array of communications structures */
                                  Exo_DB *,  /* exo - ptr to finite element mesh database */
...
EXTERN void retrieve_UM_parameter(double *,  /* PARAMETER VALUE */
                                  int,       /* Material number index */
                                  int,       /* Material property tag */
                                  int,       /* Material property tag subindex */
                                  Comm_Ex *, /* cx  - array of communications structures */
