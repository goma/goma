...
PROTO((Exo_DB *,		/* ptr to EXODUS II FE database */
...
PROTO((Exo_DB *,		/* see exo_struct.h for full def         (in)*/
...
PROTO(( const int ));		/* ebid - element block ID                   */
