...
#define LUBP                  163 /*  Lubrication Pressure    */
#define SHELL_FILMP           164 /*  Lubrication pressure of a thin film */
#define SHELL_FILMH           165 /*  Film thickness */
#define SHELL_PARTC           166 /*  Particle concentration in the thin film */
#define SHELL_SAT_CLOSED      167 /*  Structured porous shell saturation - closed pores - SAR */
#define SHELL_PRESS_OPEN      168 /*  Structured porous shell saturation - open pores - SAR */
#define SHELL_TEMPERATURE     169 /*  Shell temperature */
#define SHELL_DELTAH          170 /*  Lubrication shell thickness change (melting problems)*/
#define SHELL_LUB_CURV        171 /*  Curvature from the level set field in a lubrication shell - SAR */
#define SHELL_SAT_GASN        172 /*  Structured porous shell saturation - gas compression - SAR */
#define SHELL_SHEAR_TOP       173 /*  Shear rate at top wall - lubrication shell for generalized Newtonian flow */
#define SHELL_SHEAR_BOT       174 /*  Shear rate at bottom wall - lubrication shell for generalized Newtonian flow */
#define SHELL_CROSS_SHEAR     175 /*  Cross stream shear stress - lubrication shell for generalized Newtonian flow */
#define MAX_STRAIN            176 /*  Time-history maximum von mises strain in a solid material */
#define CUR_STRAIN            177 /*  Current value of the von mises strain in a solid material */
#define LUBP_2                178 /*  Second Lubrication Pressure for multilayer problems  */
#define SHELL_PRESS_OPEN_2    179 /*  Second Structured porous shell pressure - open pores - SAR */
#define SHELL_LUB_CURV_2      180 /*  Curvature from the phase field in a lubrication_2 shell - PRS*/
#define LIGHT_INTP            181 /*  Light Intensity - Plus direction propagation-RBS*/
#define LIGHT_INTM            182 /*  Light Intensity - Minus direction propagation-RBS*/
#define LIGHT_INTD            183 /*  Light Intensity - Scattering Dispersion-RBS*/
/*
...
#define R_SHELL_CURVATURE2      136 /*  Curvature for structural shell elements*/
...
#define R_LUBP                  163 /*  Lubrication pressure Reynolds equation */
#define R_SHELL_FILMP           164 /*  Lubrication pressure of a thin film */
#define R_SHELL_FILMH           165 /*  Film thickness */
#define R_SHELL_PARTC           166 /*  Particles concentration */
#define R_SHELL_SAT_CLOSED      167 /*  Structured porous shell - Closed pores - SAR  */
#define R_SHELL_SAT_OPEN        168 /*  Structured porous shell - Open pores - SAR  */
#define R_SHELL_ENERGY          169 /*  Shell energy equation */
#define R_SHELL_DELTAH          170 /*  Shell gap evolution equation (e.g. melting problems) */
#define R_SHELL_LUB_CURV        171 /*  Curvature from the level set field in a lubrication shell - SAR */
#define R_SHELL_SAT_GASN        172 /*  Structured porous shell - Gas compression - SAR */
#define R_SHELL_SHEAR_TOP       173 /*  Shear rate at top wall - lubrication shell for generalized Newtonian flow */
#define R_SHELL_SHEAR_BOT       174 /*  Shear rate at bottom wall - lubrication shell for generalized Newtonian flow */
#define R_SHELL_CROSS_SHEAR     175 /*  Cross stream shear stress - lubrication shell for generalized Newtonian flow */
#define R_MAX_STRAIN            176 /*  Time-history maximum von mises strain in a solid material */
#define R_CUR_STRAIN            177 /*  Current value of the von mises strain in a solid material */
#define R_LUBP_2                178 /*  Second lubrication_pressure for multilayer flows */
#define R_SHELL_SAT_OPEN_2      179 /*  Second open pore shell lubrication saturation */
#define R_SHELL_LUB_CURV_2      180 /*  Curvature from the phase field in a lubrication_2 shell - PRS */
#define R_LIGHT_INTP            181 /*  Light Intensity - Plus direction propagation*/
#define R_LIGHT_INTM            182 /*  Light Intensity - Minus direction propagation*/
#define R_LIGHT_INTD            183 /*  Light Intensity - Scattering Dispersion*/
#define V_LAST		        184
