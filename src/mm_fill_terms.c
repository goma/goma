      ...
      ***************************************************************************/
{
  ...
  if (pdv[TEMPERATURE]) {
    v = TEMPERATURE;
    scalar_fv_fill(esp->T, esp_dot->T, esp_old->T, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[FILL]) {
    v = FILL;
    scalar_fv_fill(esp->F, esp_dot->F, esp_old->F, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[BOND_EVOLUTION]) {
    v = BOND_EVOLUTION;
    scalar_fv_fill(esp->nn, esp_dot->nn, esp_old->nn, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[VOLTAGE] ) {
    v = VOLTAGE;
    scalar_fv_fill(esp->V, esp_dot->V, esp_old->V, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SURF_CHARGE] ) {
    v = SURF_CHARGE;
    scalar_fv_fill(esp->qs, esp_dot->qs, esp_old->qs, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_CURVATURE] ) {
    v = SHELL_CURVATURE;
    scalar_fv_fill(esp->sh_K, esp_dot->sh_K, esp_old->sh_K, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_TENSION] ) {
    v = SHELL_TENSION;
    scalar_fv_fill(esp->sh_tens, esp_dot->sh_tens, esp_old->sh_tens, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_X] ) {
    v = SHELL_X      ;
    scalar_fv_fill(esp->sh_x, esp_dot->sh_x, esp_old->sh_x, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_Y] ) {
    v = SHELL_Y      ;
    scalar_fv_fill(esp->sh_y, esp_dot->sh_y, esp_old->sh_y, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_USER] ) {
    v = SHELL_USER   ;
    scalar_fv_fill(esp->sh_u, esp_dot->sh_u, esp_old->sh_u, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[CURVATURE] )
    {
      v = CURVATURE;
      scalar_fv_fill(esp->H, esp_dot->H, esp_old->H, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  */
  ...
  if ( pdv[NORMAL1] )
    {
      v = NORMAL1;
      scalar_fv_fill(esp->n[0], esp_dot->n[0], esp_old->n[0], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[NORMAL2] )
    {
      v = NORMAL2;
      scalar_fv_fill(esp->n[1], esp_dot->n[1], esp_old->n[1], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[NORMAL3] )
    {
      v = NORMAL3;
      scalar_fv_fill(esp->n[2], esp_dot->n[2], esp_old->n[2], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_SURF_DIV_V]) {
    v = SHELL_SURF_DIV_V     ;
    scalar_fv_fill(esp->div_s_v, esp_dot->div_s_v, esp_old->div_s_v, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_SURF_CURV] ) {
    v = SHELL_SURF_CURV    ;
    scalar_fv_fill(esp->curv, esp_dot->curv, esp_old->curv, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[N_DOT_CURL_V] ) {
    v = N_DOT_CURL_V    ;
    scalar_fv_fill(esp->n_dot_curl_s_v, esp_dot->n_dot_curl_s_v, esp_old->n_dot_curl_s_v, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[GRAD_S_V_DOT_N1] ) {
    v = GRAD_S_V_DOT_N1    ;
    scalar_fv_fill(esp->grad_v_dot_n[0], esp_dot->grad_v_dot_n[0], esp_old->grad_v_dot_n[0], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[GRAD_S_V_DOT_N2] ) {
    v = GRAD_S_V_DOT_N2    ;
    scalar_fv_fill(esp->grad_v_dot_n[1], esp_dot->grad_v_dot_n[1], esp_old->grad_v_dot_n[1], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[GRAD_S_V_DOT_N3] ) {
    v = GRAD_S_V_DOT_N3    ;
    scalar_fv_fill(esp->grad_v_dot_n[2], esp_dot->grad_v_dot_n[2], esp_old->grad_v_dot_n[2], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_DIFF_FLUX] ) {
    v = SHELL_DIFF_FLUX  ;
    scalar_fv_fill(esp->sh_J, esp_dot->sh_J, esp_old->sh_J, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if ( pdv[SHELL_DIFF_CURVATURE] ) {
    ...
    scalar_fv_fill(esp->sh_Kd, esp_dot->sh_Kd, esp_old->sh_Kd, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[ACOUS_PREAL]) {
    v = ACOUS_PREAL;
    scalar_fv_fill(esp->apr, esp_dot->apr, esp_old->apr, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[ACOUS_PIMAG]) {
    v = ACOUS_PIMAG;
    scalar_fv_fill(esp->api, esp_dot->api, esp_old->api, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[ACOUS_REYN_STRESS]) {
    v = ACOUS_REYN_STRESS;
    scalar_fv_fill(esp->ars, esp_dot->ars, esp_old->ars, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_BDYVELO]) {
    v = SHELL_BDYVELO;
    scalar_fv_fill(esp->sh_bv, esp_dot->sh_bv, esp_old->sh_bv, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_LUBP]) {
    v = SHELL_LUBP;
    scalar_fv_fill(esp->sh_p, esp_dot->sh_p, esp_old->sh_p, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[LUBP]) {
    v = LUBP;
    scalar_fv_fill(esp->lubp, esp_dot->lubp, esp_old->lubp, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[LUBP_2]) {
    v = LUBP_2;
    scalar_fv_fill(esp->lubp_2, esp_dot->lubp_2, esp_old->lubp_2, bf[v]->phi, ei[pg->imtrx]->dof[v],
 ...
 if (pdv[SHELL_FILMP]) {
    v = SHELL_FILMP;
    scalar_fv_fill(esp->sh_fp, esp_dot->sh_fp, esp_old->sh_fp, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_FILMH]) {
    v = SHELL_FILMH;
    scalar_fv_fill(esp->sh_fh, esp_dot->sh_fh, esp_old->sh_fh, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_PARTC]) {
    v = SHELL_PARTC;
    scalar_fv_fill(esp->sh_pc, esp_dot->sh_pc, esp_old->sh_pc, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_SAT_CLOSED]) {
    v = SHELL_SAT_CLOSED;
    scalar_fv_fill(esp->sh_sat_closed, esp_dot->sh_sat_closed, esp_old->sh_sat_closed, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_PRESS_OPEN]) {
    v = SHELL_PRESS_OPEN;
    scalar_fv_fill(esp->sh_p_open, esp_dot->sh_p_open, esp_old->sh_p_open, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_PRESS_OPEN_2]) {
    ...
    scalar_fv_fill(esp->sh_p_open_2, esp_dot->sh_p_open_2, esp_old->sh_p_open_2, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_TEMPERATURE]) {
    v = SHELL_TEMPERATURE;
    scalar_fv_fill(esp->sh_t, esp_dot->sh_t, esp_old->sh_t, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_t), &(fv_dot->sh_t), &(fv_old->sh_t));
    stateVector[SHELL_TEMPERATURE] = fv->sh_t;
  } 
  if (pdv[SHELL_DELTAH]) {
    v = SHELL_DELTAH;
    scalar_fv_fill(esp->sh_dh, esp_dot->sh_dh, esp_old->sh_dh, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_dh), &(fv_dot->sh_dh), &(fv_old->sh_dh));
    stateVector[SHELL_DELTAH] = fv->sh_dh;
  } 
  if (pdv[SHELL_LUB_CURV]) {
    v = SHELL_LUB_CURV;
    scalar_fv_fill(esp->sh_l_curv, esp_dot->sh_l_curv, esp_old->sh_l_curv, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_l_curv), &(fv_dot->sh_l_curv), &(fv_old->sh_l_curv));
    stateVector[SHELL_LUB_CURV] = fv->sh_l_curv;
  } 
  if (pdv[SHELL_LUB_CURV_2]) {
    v = SHELL_LUB_CURV_2;
    scalar_fv_fill(esp->sh_l_curv_2, esp_dot->sh_l_curv_2, esp_old->sh_l_curv_2, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_l_curv_2), &(fv_dot->sh_l_curv_2), &(fv_old->sh_l_curv_2));
    stateVector[SHELL_LUB_CURV] = fv->sh_l_curv;
  } 
  if (pdv[SHELL_SAT_GASN]) {
    v = SHELL_SAT_GASN;
    scalar_fv_fill(esp->sh_sat_gasn, esp_dot->sh_sat_gasn, esp_old->sh_sat_gasn, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_sat_gasn), &(fv_dot->sh_sat_gasn), &(fv_old->sh_sat_gasn));
    stateVector[SHELL_SAT_GASN] = fv->sh_sat_gasn;
  } 
  if (pdv[SHELL_SHEAR_TOP]) {
    v = SHELL_SHEAR_TOP;
    scalar_fv_fill(esp->sh_shear_top, esp_dot->sh_shear_top, esp_old->sh_shear_top, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_shear_top), &(fv_dot->sh_shear_top), &(fv_old->sh_shear_top));
    stateVector[SHELL_SHEAR_TOP] = fv->sh_shear_top;
  }
  if (pdv[SHELL_SHEAR_BOT]) {
    v = SHELL_SHEAR_BOT;
    scalar_fv_fill(esp->sh_shear_bot, esp_dot->sh_shear_bot, esp_old->sh_shear_bot, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[SHELL_CROSS_SHEAR]) {
    v = SHELL_CROSS_SHEAR;
    scalar_fv_fill(esp->sh_cross_shear, esp_dot->sh_cross_shear, esp_old->sh_cross_shear, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->sh_cross_shear), &(fv_dot->sh_cross_shear), &(fv_old->sh_cross_shear));
    stateVector[SHELL_CROSS_SHEAR] = fv->sh_cross_shear;
  }
  if (pdv[MAX_STRAIN]) {
    v = MAX_STRAIN;
    scalar_fv_fill(esp->max_strain, esp_dot->max_strain, esp_old->max_strain, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->max_strain), &(fv_dot->max_strain), &(fv_old->max_strain));
    stateVector[MAX_STRAIN] = fv->max_strain;
  }
  if (pdv[CUR_STRAIN]) {
    v = CUR_STRAIN;
    scalar_fv_fill(esp->cur_strain, esp_dot->cur_strain, esp_old->cur_strain, bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->cur_strain), &(fv_dot->cur_strain), &(fv_old->cur_strain));
    stateVector[CUR_STRAIN] = fv->cur_strain;
  }
  if ( pdv[LIGHT_INTP] ) {
    v = LIGHT_INTP    ;
    scalar_fv_fill(esp->poynt[0], esp_dot->poynt[0], esp_old->poynt[0], bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->poynt[0]), &(fv_dot->poynt[0]), &(fv_old->poynt[0]));
    stateVector[LIGHT_INTP] = fv->poynt[0];
  } 
  if ( pdv[LIGHT_INTM] ) {
    v = LIGHT_INTM    ;
    scalar_fv_fill(esp->poynt[1], esp_dot->poynt[1], esp_old->poynt[1], bf[v]->phi, ei[pg->imtrx]->dof[v],
                   &(fv->poynt[1]), &(fv_dot->poynt[1]), &(fv_old->poynt[1]));
    stateVector[LIGHT_INTM] = fv->poynt[1];
  } 
  if ( pdv[LIGHT_INTD] ) {
    v = LIGHT_INTD    ;
    scalar_fv_fill(esp->poynt[2], esp_dot->poynt[2], esp_old->poynt[2], bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[POR_SINK_MASS]) {
    v = POR_SINK_MASS;
    scalar_fv_fill(esp->sink_mass, esp_dot->sink_mass, esp_old->sink_mass, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  if (pdv[PRESSURE]) 
    {
      v = PRESSURE;
      scalar_fv_fill(esp->P, esp_dot->P, esp_old->P, bf[v]->phi, ei[pg->imtrx]->dof[v],
  ...
  for (p = 0; pdv[MESH_DISPLACEMENT1] && p < dim; p++)
      ...
      if (tran->solid_inertia)
	{
       ...
       * and ei[pg->imtrx]->deforming_mesh will be TRUE, so that the true
  ...
  for (p = 0; pdv[SOLID_DISPLACEMENT1] && p < dim; p++)
      ...
      if ( pdv[v] )
	{
	  ...
	  for (i = 0; i < dofs; i++)
	    {
	      node = ei[pg->imtrx]->dof_list[R_SOLID1][i];
	      index = Proc_Elem_Connect[Proc_Connect_Ptr[ei[pg->imtrx]->ielem] +node];
  ...
  if ( pdv[EXT_VELOCITY] )
    {
      scalar_fv_fill(esp->ext_v, esp_dot->ext_v, esp_old->ext_v, bf[v]->phi, 
		     ei[pg->imtrx]->dof[v], &(fv->ext_v), &(fv_dot->ext_v), &(fv_old->ext_v));
  ...
  for( p=0; pdv[PHASE1] && p<pfd->num_phase_funcs; p++)
    {
      ...
      if ( pdv[v] )
	{
	  scalar_fv_fill(esp->pF[p], esp_dot->pF[p], esp_old->pF[p], bf[v]->phi, ei[pg->imtrx]->dof[v],
...
load_fv_all(void)
     ...
     /*******************************************************************************
      * load_fv_all() -- load up values of all relevant field variables at the
      *              current gauss pt from other matrices
      *
      * TODO: Refactor this is duplicated code from load_fv and currently requires
      ...
      ***************************************************************************/
{
  ...
  for (imtrx = 0; imtrx < upd->Total_Num_Matrices; imtrx++) {
    ...
    /* Current matrix was already done in load_fv */
    ...
    if (pdv[TEMPERATURE]) {
      v = TEMPERATURE;
      scalar_fv_fill(esp->T, esp_dot->T, esp_old->T, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->T), &(fv_dot->T), &(fv_old->T));
      stateVector[TEMPERATURE] = fv->T;
    } /*else if (upd->vp[imtrx][v] == -1) {
        fv->T     = mp->reference[TEMPERATURE];
        fv_old->T = 0.;
        fv_dot->T = 0.;
        } */
    ...
    if (pdv[FILL]) {
      v = FILL;
      scalar_fv_fill(esp->F, esp_dot->F, esp_old->F, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->F), &(fv_dot->F), &(fv_old->F));
      stateVector[v] = fv->F;
    } /*else if (upd->vp[imtrx][v] == -1) {
        fv->F = fv_old->F = fv_dot->F = 0.;
    ...
    if (pdv[BOND_EVOLUTION]) {
      v = BOND_EVOLUTION;
      scalar_fv_fill(esp->nn, esp_dot->nn, esp_old->nn, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->nn), &(fv_dot->nn), &(fv_old->nn));
      stateVector[v] = fv->nn;
    } /*else if (upd->vp[imtrx][v] == -1)  {
        fv->nn = fv_old->nn = fv_dot->nn = 0.;
    ...
    if ( pdv[VOLTAGE] ) {
      v = VOLTAGE;
      scalar_fv_fill(esp->V, esp_dot->V, esp_old->V, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->V), &(fv_dot->V), &(fv_old->V));
      stateVector[VOLTAGE] = fv->V;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->V = fv_old->V = fv_dot->V = 0.;
    ...
    if ( pdv[SURF_CHARGE] ) {
      v = SURF_CHARGE;
      scalar_fv_fill(esp->qs, esp_dot->qs, esp_old->qs, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->qs), &(fv_dot->qs), &(fv_old->qs));
      stateVector[SURF_CHARGE] = fv->qs;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->qs = fv_old->qs = fv_dot->qs = 0.;
    ...
    if ( pdv[SHELL_CURVATURE] ) {
      v = SHELL_CURVATURE;
      scalar_fv_fill(esp->sh_K, esp_dot->sh_K, esp_old->sh_K, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_K), &(fv_dot->sh_K), &(fv_old->sh_K));
      stateVector[SHELL_CURVATURE] = fv->sh_K;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->sh_K = fv_old->sh_K = fv_dot->sh_K = 0.;
    ...
    if ( pdv[SHELL_TENSION] ) {
      v = SHELL_TENSION;
      scalar_fv_fill(esp->sh_tens, esp_dot->sh_tens, esp_old->sh_tens, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_tens), &(fv_dot->sh_tens), &(fv_old->sh_tens));
      stateVector[SHELL_TENSION] = fv->sh_tens;
    } /*else if ( updvp[v] == -1 ) {
        fv->sh_tens = fv_old->sh_tens = fv_dot->sh_tens = 0.;
    ...
    if ( pdv[SHELL_X] ) {
      v = SHELL_X      ;
      scalar_fv_fill(esp->sh_x, esp_dot->sh_x, esp_old->sh_x, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_x), &(fv_dot->sh_x), &(fv_old->sh_x));
      stateVector[SHELL_X] = fv->sh_x;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->sh_x = fv_old->sh_x = fv_dot->sh_x    = 0.;
    ...
    if ( pdv[SHELL_Y] ) {
      v = SHELL_Y      ;
      scalar_fv_fill(esp->sh_y, esp_dot->sh_y, esp_old->sh_y, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_y), &(fv_dot->sh_y), &(fv_old->sh_y));
      stateVector[SHELL_Y] = fv->sh_y;
    } /* else if ( upd->vp[imtrx][v] == -1 ) {
         fv->sh_y = fv_old->sh_y = fv_dot->sh_y    = 0.;
    ...
    if ( pdv[SHELL_USER] ) {
      v = SHELL_USER   ;
      scalar_fv_fill(esp->sh_u, esp_dot->sh_u, esp_old->sh_u, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_u), &(fv_dot->sh_u), &(fv_old->sh_u));
      stateVector[SHELL_USER] = fv->sh_u;
    } /* else if ( upd->vp[imtrx][v] == -1 ) {
         fv->sh_u = fv_old->sh_u = fv_dot->sh_u    = 0.;
    ...
    if ( pdv[CURVATURE] )
      {
        v = CURVATURE;
        scalar_fv_fill(esp->H, esp_dot->H, esp_old->H, bf[v]->phi, ei[imtrx]->dof[v],
                       &(fv->H), &(fv_dot->H), &(fv_old->H));
    ...
    */
    ...
    if ( pdv[NORMAL1] )
      {
        v = NORMAL1;
        scalar_fv_fill(esp->n[0], esp_dot->n[0], esp_old->n[0], bf[v]->phi, ei[imtrx]->dof[v],
                       &(fv->n[0]), &(fv_dot->n[0]), &(fv_old->n[0]));
    ...
    if ( pdv[NORMAL2] )
      {
        v = NORMAL2;
        scalar_fv_fill(esp->n[1], esp_dot->n[1], esp_old->n[1], bf[v]->phi, ei[imtrx]->dof[v],
                       &(fv->n[1]), &(fv_dot->n[1]), &(fv_old->n[1]));
    ...
    if ( pdv[NORMAL3] )
      {
        v = NORMAL3;
        scalar_fv_fill(esp->n[2], esp_dot->n[2], esp_old->n[2], bf[v]->phi, ei[imtrx]->dof[v],
                       &(fv->n[2]), &(fv_dot->n[2]), &(fv_old->n[2]));
    ...
    if (pdv[SHELL_SURF_DIV_V]) {
      v = SHELL_SURF_DIV_V     ;
      scalar_fv_fill(esp->div_s_v, esp_dot->div_s_v, esp_old->div_s_v, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->div_s_v), &(fv_dot->div_s_v), &(fv_old->div_s_v));
      stateVector[SHELL_SURF_DIV_V] = fv->div_s_v;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->div_s_v = fv_old->div_s_v = fv_dot->div_s_v    = 0.;
    ...
    if ( pdv[SHELL_SURF_CURV] ) {
      v = SHELL_SURF_CURV    ;
      scalar_fv_fill(esp->curv, esp_dot->curv, esp_old->curv, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->curv), &(fv_dot->curv), &(fv_old->curv));
      stateVector[SHELL_SURF_CURV] = fv->curv;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->curv = fv_old->curv = fv_dot->curv    = 0.;
    ...
    if ( pdv[N_DOT_CURL_V] ) {
      v = N_DOT_CURL_V    ;
      scalar_fv_fill(esp->n_dot_curl_s_v, esp_dot->n_dot_curl_s_v, esp_old->n_dot_curl_s_v, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->n_dot_curl_s_v), &(fv_dot->n_dot_curl_s_v), &(fv_old->n_dot_curl_s_v));
      stateVector[N_DOT_CURL_V] = fv->n_dot_curl_s_v;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->n_dot_curl_s_v = fv_old->n_dot_curl_s_v = fv_dot->n_dot_curl_s_v    = 0.;
    ...
    if ( pdv[GRAD_S_V_DOT_N1] ) {
      v = GRAD_S_V_DOT_N1    ;
      scalar_fv_fill(esp->grad_v_dot_n[0], esp_dot->grad_v_dot_n[0], esp_old->grad_v_dot_n[0], bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->grad_v_dot_n[0]), &(fv_dot->grad_v_dot_n[0]), &(fv_old->grad_v_dot_n[0]));
      stateVector[GRAD_S_V_DOT_N1] = fv->grad_v_dot_n[0];
    }/* else if ( upd->vp[imtrx][v] == -1 ) {
        fv->grad_v_dot_n[0] = fv_old->grad_v_dot_n[0] = fv_dot->grad_v_dot_n[0]    = 0.;
    ...
    if ( pdv[GRAD_S_V_DOT_N2] ) {
      v = GRAD_S_V_DOT_N2    ;
      scalar_fv_fill(esp->grad_v_dot_n[1], esp_dot->grad_v_dot_n[1], esp_old->grad_v_dot_n[1], bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->grad_v_dot_n[1]), &(fv_dot->grad_v_dot_n[1]), &(fv_old->grad_v_dot_n[1]));
      stateVector[GRAD_S_V_DOT_N2] = fv->grad_v_dot_n[1];
    }/* else if ( upd->vp[imtrx][v] == -1 ) {
        fv->grad_v_dot_n[1] = fv_old->grad_v_dot_n[1] = fv_dot->grad_v_dot_n[1]    = 0.;
    ...
    if ( pdv[GRAD_S_V_DOT_N3] ) {
      v = GRAD_S_V_DOT_N3    ;
      scalar_fv_fill(esp->grad_v_dot_n[2], esp_dot->grad_v_dot_n[2], esp_old->grad_v_dot_n[2], bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->grad_v_dot_n[2]), &(fv_dot->grad_v_dot_n[2]), &(fv_old->grad_v_dot_n[2]));
      stateVector[GRAD_S_V_DOT_N3] = fv->grad_v_dot_n[2];
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->grad_v_dot_n[2] = fv_old->grad_v_dot_n[2] = fv_dot->grad_v_dot_n[2]    = 0.;
    ...
    if ( pdv[SHELL_DIFF_FLUX] ) {
      v = SHELL_DIFF_FLUX  ;
      scalar_fv_fill(esp->sh_J, esp_dot->sh_J, esp_old->sh_J, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_J), &(fv_dot->sh_J), &(fv_old->sh_J));
      stateVector[SHELL_DIFF_FLUX] = fv->sh_J;
    } /*else if ( upd->vp[imtrx][v] == -1 ) {
        fv->sh_J = fv_old->sh_J = fv_dot->sh_J = 0.;
    ...
    if ( pdv[SHELL_DIFF_CURVATURE] ) {
      v = SHELL_DIFF_CURVATURE;
      scalar_fv_fill(esp->sh_Kd, esp_dot->sh_Kd, esp_old->sh_Kd, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_Kd), &(fv_dot->sh_Kd), &(fv_old->sh_Kd));
      stateVector[SHELL_DIFF_CURVATURE] = fv->sh_Kd;
    }/* else if ( upd->vp[imtrx][v] == -1 ) {
        fv->sh_Kd = fv_old->sh_Kd = fv_dot->sh_Kd = 0.;
    ...
    if (pdv[ACOUS_PREAL]) {
      v = ACOUS_PREAL;
      scalar_fv_fill(esp->apr, esp_dot->apr, esp_old->apr, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->apr), &(fv_dot->apr), &(fv_old->apr));
      stateVector[ACOUS_PREAL] = fv->apr;
    } /*else if (upd->vp[imtrx][v] == -1) {
        fv->apr = fv_old->apr = fv_dot->apr = 0.;
    ...
    if (pdv[ACOUS_PIMAG]) {
      v = ACOUS_PIMAG;
      scalar_fv_fill(esp->api, esp_dot->api, esp_old->api, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->api), &(fv_dot->api), &(fv_old->api));
      stateVector[ACOUS_PIMAG] = fv->api;
    } /*else if (upd->vp[imtrx][v] == -1) {
        fv->api = fv_old->api = fv_dot->api = 0.;
    ...
    if (pdv[ACOUS_REYN_STRESS]) {
      v = ACOUS_REYN_STRESS;
      scalar_fv_fill(esp->ars, esp_dot->ars, esp_old->ars, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->ars), &(fv_dot->ars), &(fv_old->ars));
      stateVector[ACOUS_REYN_STRESS] = fv->ars;
    } /*else if (upd->vp[imtrx][v] == -1) {
        fv->ars = fv_old->ars = fv_dot->ars = 0.;
    ...
    if (pdv[SHELL_BDYVELO]) {
      v = SHELL_BDYVELO;
      scalar_fv_fill(esp->sh_bv, esp_dot->sh_bv, esp_old->sh_bv, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_bv), &(fv_dot->sh_bv), &(fv_old->sh_bv));
      stateVector[SHELL_BDYVELO] = fv->sh_bv;
    } /*else if (upd->vp[imtrx][v] == -1) { */
    ...
    if (pdv[SHELL_LUBP]) {
      v = SHELL_LUBP;
      scalar_fv_fill(esp->sh_p, esp_dot->sh_p, esp_old->sh_p, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_p), &(fv_dot->sh_p), &(fv_old->sh_p));
      stateVector[SHELL_LUBP] = fv->sh_p;
    } 
    ...
    if (pdv[LUBP]) {
      v = LUBP;
      scalar_fv_fill(esp->lubp, esp_dot->lubp, esp_old->lubp, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->lubp), &(fv_dot->lubp), &(fv_old->lubp));
      stateVector[LUBP] = fv->lubp;
    } 
    ...
    if (pdv[LUBP_2]) {
      v = LUBP_2;
      scalar_fv_fill(esp->lubp_2, esp_dot->lubp_2, esp_old->lubp_2, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->lubp_2), &(fv_dot->lubp_2), &(fv_old->lubp_2));
      stateVector[LUBP_2] = fv->lubp_2;
    } 
    ...
    if (pdv[SHELL_FILMP]) {
      v = SHELL_FILMP;
      scalar_fv_fill(esp->sh_fp, esp_dot->sh_fp, esp_old->sh_fp, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_fp), &(fv_dot->sh_fp), &(fv_old->sh_fp));
      stateVector[SHELL_FILMP] = fv->sh_fp;
    } 
    ...
    if (pdv[SHELL_FILMH]) {
      v = SHELL_FILMH;
      scalar_fv_fill(esp->sh_fh, esp_dot->sh_fh, esp_old->sh_fh, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_fh), &(fv_dot->sh_fh), &(fv_old->sh_fh));
      stateVector[SHELL_FILMH] = fv->sh_fh;
    } 
    ...
    if (pdv[SHELL_PARTC]) {
      v = SHELL_PARTC;
      scalar_fv_fill(esp->sh_pc, esp_dot->sh_pc, esp_old->sh_pc, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_pc), &(fv_dot->sh_pc), &(fv_old->sh_pc));
      stateVector[SHELL_PARTC] = fv->sh_pc;
    } 
    ...
    if (pdv[SHELL_SAT_CLOSED]) {
      v = SHELL_SAT_CLOSED;
      scalar_fv_fill(esp->sh_sat_closed, esp_dot->sh_sat_closed, esp_old->sh_sat_closed, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_sat_closed), &(fv_dot->sh_sat_closed), &(fv_old->sh_sat_closed));
      stateVector[SHELL_SAT_CLOSED] = fv->sh_sat_closed;
    } 
    if (pdv[SHELL_PRESS_OPEN]) {
      v = SHELL_PRESS_OPEN;
      scalar_fv_fill(esp->sh_p_open, esp_dot->sh_p_open, esp_old->sh_p_open, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_p_open), &(fv_dot->sh_p_open), &(fv_old->sh_p_open));
      stateVector[SHELL_PRESS_OPEN] = fv->sh_p_open;
    } 
    if (pdv[SHELL_PRESS_OPEN_2]) {
      v = SHELL_PRESS_OPEN_2;
      scalar_fv_fill(esp->sh_p_open_2, esp_dot->sh_p_open_2, esp_old->sh_p_open_2, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_p_open_2), &(fv_dot->sh_p_open_2), &(fv_old->sh_p_open_2));
      stateVector[SHELL_PRESS_OPEN_2] = fv->sh_p_open_2;
    } 
    if (pdv[SHELL_TEMPERATURE]) {
      v = SHELL_TEMPERATURE;
      scalar_fv_fill(esp->sh_t, esp_dot->sh_t, esp_old->sh_t, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_t), &(fv_dot->sh_t), &(fv_old->sh_t));
      stateVector[SHELL_TEMPERATURE] = fv->sh_t;
    } 
    if (pdv[SHELL_DELTAH]) {
      v = SHELL_DELTAH;
      scalar_fv_fill(esp->sh_dh, esp_dot->sh_dh, esp_old->sh_dh, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_dh), &(fv_dot->sh_dh), &(fv_old->sh_dh));
      stateVector[SHELL_DELTAH] = fv->sh_dh;
    } 
    if (pdv[SHELL_LUB_CURV]) {
      v = SHELL_LUB_CURV;
      scalar_fv_fill(esp->sh_l_curv, esp_dot->sh_l_curv, esp_old->sh_l_curv, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_l_curv), &(fv_dot->sh_l_curv), &(fv_old->sh_l_curv));
      stateVector[SHELL_LUB_CURV] = fv->sh_l_curv;
    } 
    if (pdv[SHELL_LUB_CURV_2]) {
      v = SHELL_LUB_CURV_2;
      scalar_fv_fill(esp->sh_l_curv_2, esp_dot->sh_l_curv_2, esp_old->sh_l_curv_2, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_l_curv_2), &(fv_dot->sh_l_curv_2), &(fv_old->sh_l_curv_2));
      stateVector[SHELL_LUB_CURV] = fv->sh_l_curv;
    } 
    if (pdv[SHELL_SAT_GASN]) {
      v = SHELL_SAT_GASN;
      scalar_fv_fill(esp->sh_sat_gasn, esp_dot->sh_sat_gasn, esp_old->sh_sat_gasn, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_sat_gasn), &(fv_dot->sh_sat_gasn), &(fv_old->sh_sat_gasn));
      stateVector[SHELL_SAT_GASN] = fv->sh_sat_gasn;
    } 
    if (pdv[SHELL_SHEAR_TOP]) {
      v = SHELL_SHEAR_TOP;
      scalar_fv_fill(esp->sh_shear_top, esp_dot->sh_shear_top, esp_old->sh_shear_top, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_shear_top), &(fv_dot->sh_shear_top), &(fv_old->sh_shear_top));
      stateVector[SHELL_SHEAR_TOP] = fv->sh_shear_top;
    }
    if (pdv[SHELL_SHEAR_BOT]) {
      v = SHELL_SHEAR_BOT;
      scalar_fv_fill(esp->sh_shear_bot, esp_dot->sh_shear_bot, esp_old->sh_shear_bot, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_shear_bot), &(fv_dot->sh_shear_bot), &(fv_old->sh_shear_bot));
      stateVector[SHELL_SHEAR_BOT] = fv->sh_shear_bot;
    }
    if (pdv[SHELL_CROSS_SHEAR]) {
      v = SHELL_CROSS_SHEAR;
      scalar_fv_fill(esp->sh_cross_shear, esp_dot->sh_cross_shear, esp_old->sh_cross_shear, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sh_cross_shear), &(fv_dot->sh_cross_shear), &(fv_old->sh_cross_shear));
      stateVector[SHELL_CROSS_SHEAR] = fv->sh_cross_shear;
    }
    if (pdv[MAX_STRAIN]) {
      v = MAX_STRAIN;
      scalar_fv_fill(esp->max_strain, esp_dot->max_strain, esp_old->max_strain, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->max_strain), &(fv_dot->max_strain), &(fv_old->max_strain));
      stateVector[MAX_STRAIN] = fv->max_strain;
    }
    if (pdv[CUR_STRAIN]) {
      v = CUR_STRAIN;
      scalar_fv_fill(esp->cur_strain, esp_dot->cur_strain, esp_old->cur_strain, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->cur_strain), &(fv_dot->cur_strain), &(fv_old->cur_strain));
      stateVector[CUR_STRAIN] = fv->cur_strain;
    }
    if ( pdv[LIGHT_INTP] ) {
      v = LIGHT_INTP    ;
      scalar_fv_fill(esp->poynt[0], esp_dot->poynt[0], esp_old->poynt[0], bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->poynt[0]), &(fv_dot->poynt[0]), &(fv_old->poynt[0]));
      stateVector[LIGHT_INTP] = fv->poynt[0];
    } 
    if ( pdv[LIGHT_INTM] ) {
      v = LIGHT_INTM    ;
      scalar_fv_fill(esp->poynt[1], esp_dot->poynt[1], esp_old->poynt[1], bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->poynt[1]), &(fv_dot->poynt[1]), &(fv_old->poynt[1]));
      stateVector[LIGHT_INTM] = fv->poynt[1];
    } 
    if ( pdv[LIGHT_INTD] ) {
      v = LIGHT_INTD    ;
      scalar_fv_fill(esp->poynt[2], esp_dot->poynt[2], esp_old->poynt[2], bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->poynt[2]), &(fv_dot->poynt[2]), &(fv_old->poynt[2]));
      stateVector[LIGHT_INTD] = fv->poynt[2];
    } 
    /*
    ...
    if (pdv[POR_SINK_MASS]) {
      v = POR_SINK_MASS;
      scalar_fv_fill(esp->sink_mass, esp_dot->sink_mass, esp_old->sink_mass, bf[v]->phi, ei[imtrx]->dof[v],
                     &(fv->sink_mass), &(fv_dot->sink_mass), &(fv_old->sink_mass));
      stateVector[POR_SINK_MASS] = fv->sink_mass;
    } /*else if (upd->vp[imtrx][v] == -1) {
        fv->sink_mass = fv_old->sink_mass = fv_dot->sink_mass = 0.;
    ...
    if (pdv[PRESSURE]) 
      {
        v = PRESSURE;
        scalar_fv_fill(esp->P, esp_dot->P, esp_old->P, bf[v]->phi, ei[imtrx]->dof[v],
                       &(fv->P), &(fv_dot->P), &(fv_old->P));
        stateVector[v] = fv->P + upd->Pressure_Datum;
      } 
    ...
    for (p = 0; pdv[MESH_DISPLACEMENT1] && p < dim; p++)
      {
         ...
         * defined on this element block even if the mesh is deforming.
         * In this case, displacements are defined on a neighbor block
         * and ei[imtrx]->deforming_mesh will be TRUE, so that the true
         * displaced coordinates can be loaded here.
         */
        if (ei[imtrx]->deforming_mesh)
          {
            ...
            for (i = 0; i < dofs; i++)
              {
                node = ei[imtrx]->dof_list[R_MESH1][i];
        ...
        if ( pdv[v] )
          {
            ...
            for (i = 0; i < dofs; i++)
              {
                node = ei[imtrx]->dof_list[R_SOLID1][i];
                index = Proc_Elem_Connect[Proc_Connect_Ptr[ei[imtrx]->ielem] +node];
                fv->d_rs[p] += *esp->d_rs[p][i] * bf[v]->phi[i];
    ...
    /*  for ( p=velodim; p<DIM; p++)
        {
        v = PVELOCITY1 + p;
        if ( pd->v[imtrx][v] || (upd->vp[imtrx][v] == -1) )
        {
        fv->pv[p]     = 0.;
        fv_old->pv[p] = 0.;
        fv_dot->pv[p] = 0.;
    ...
    if ( pdv[EXT_VELOCITY] )
      {
        scalar_fv_fill(esp->ext_v, esp_dot->ext_v, esp_old->ext_v, bf[v]->phi, 
                       ei[imtrx]->dof[v], &(fv->ext_v), &(fv_dot->ext_v), &(fv_old->ext_v));
        stateVector[EXT_VELOCITY] = fv->ext_v;
      }
    ...
    for( p=0; pdv[PHASE1] && p<pfd->num_phase_funcs; p++)
      {
        ...
        if ( pdv[v] )
          {
            scalar_fv_fill(esp->pF[p], esp_dot->pF[p], esp_old->pF[p], bf[v]->phi, ei[imtrx]->dof[v],
                           &(fv->pF[p]), &(fv_dot->pF[p]), &(fv_old->pF[p]));
          }
      }
    ...
    */
    ...
    for(p = 0; pdv[VORT_DIR1] && p < DIM; p++)
      {
        v = VORT_DIR1 + p;
        /*if (pd->v[imtrx][v] || upd->vp[imtrx][v] == -1) fv->vd[p] = 0.0; */
    ...
    /*  if (pd->v[imtrx][v] || upd->vp[imtrx][v] == -1) fv->vlambda = 0.0; */
...
int
load_fv_grads_all(void)
     /*******************************************************************************
      *
      * TODO: Refactor, duplicated code with load_fv_grads
      *
      *
      * load_fv_grads() -- load relevant field variable gradients at this gauss pt
      *
      ...
      ***************************************************************************/
{
  ...
  */  
  ...
  for (imtrx = 0; imtrx < upd->Total_Num_Matrices; imtrx++) {
    ...
    else if (zero_unused_grads && upd->vp[imtrx][TEMPERATURE] == -1 )
      {
        for (p=0; p<VIM; p++) fv->grad_T[p] = 0.0;
      }
    ...
    if ( pd->v[imtrx][PRESSURE] )
      ...
      } else if ( zero_unused_grads &&  upd->vp[imtrx][PRESSURE] == -1 ) {
      for (p=0; p<VIM; p++)
	{ 
	  fv->grad_P[p] = 0.0;
	  //if(transient_run && segregated)
    ...
    if ( pd->v[imtrx][FILL] )
      ...
      } else if ( zero_unused_grads &&  upd->vp[imtrx][FILL] == -1 ) {
      for (p=0; p<VIM; p++)
        {
          fv->grad_F[p] = 0.0; fv_old->grad_F[p] = 0.0; fv_dot->grad_F[p] = 0.0;
        }
    ...
    else if ( zero_unused_grads &&  upd->vp[imtrx][CURVATURE] == -1 )
      {
        for (p=0; p<VIM; p++) 
          {
            fv->grad_H[p] = 0.0;
    ...
    else  if ( zero_unused_grads &&  upd->vp[imtrx][VOLTAGE] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_V[p] = 0.0;
    } 
    ...
    else if (zero_unused_grads &&  upd->vp[imtrx][SURF_CHARGE] == -1)
      {
        for (p = 0; p < VIM-1; p++)
          {
            fv->grad_qs[p] = 0.0;
    ...
    if ( pd->v[imtrx][SHEAR_RATE] )
      ...
      } else  if (zero_unused_grads &&  upd->vp[imtrx][SHEAR_RATE] == -1 )   {
      for (p=0; p<VIM; p++) fv->grad_SH[p] = 0.0;
    }
    ...
    if (pd->v[imtrx][MESH_DISPLACEMENT1] && !ShellElementParentElementCoverageForVariable[MESH_DISPLACEMENT1])
      {
        v = MESH_DISPLACEMENT1;
        dofs = ei[imtrx]->dof[v];
        for (p = 0; p < VIM; p++)
      ...
      } else if (upd->vp[imtrx][MESH_DISPLACEMENT1] == -1) 
      {
	for (p = 0; p < VIM; p++)
	  {
	    for (q = 0; q < VIM; q++)
     ...
     * grad(d_rs)
     */
    if( pd->v[imtrx][SOLID_DISPLACEMENT1] )
      {
        for ( p=0;  p<VIM; p++)
          {
            for ( q=0; q<VIM; q++)
      ...
      } else if ( zero_unused_grads &&  upd->vp[imtrx][SOLID_DISPLACEMENT1] == -1 )
      {
	memset(fv->grad_d_rs, 0, sizeof(double) *VIM*VIM);
      }
    ...
    if (pd->v[imtrx][MESH_DISPLACEMENT1] && !ShellElementParentElementCoverageForVariable[MESH_DISPLACEMENT1])
      ...
      } else if (zero_unused_grads && upd->vp[imtrx][MESH_DISPLACEMENT1] == -1) {
      fv->div_d_dot = 0.0;
      fv->div_d     = 0.0;
    }
    ...
    else if (zero_unused_grads && upd->vp[imtrx][VELOCITY1] == -1) 
      {
        for (p = 0; p < VIM; p++)
          {
            for (q = 0; q < VIM; q++)
     ...
     * grad(pv), particle velocity gradients.
     */
    if (pd->v[imtrx][PVELOCITY1])
      {
        dofs = ei[imtrx]->dof[PVELOCITY1];
        v = PVELOCITY1;
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][PVELOCITY1] == -1 ) {
      for ( p=0; p<VIM; p++)
	{
	  for ( q=0; q<VIM; q++)
	    {
    ...
    if( pd->v[imtrx][EXT_VELOCITY] )
      {
        dofs = ei[imtrx]->dof[EXT_VELOCITY];
        v = EXT_VELOCITY;
      ...
      } else if (zero_unused_grads &&  upd->vp[imtrx][EXT_VELOCITY] == -1 ) {
      for ( p=0; p<VIM; p++)
        {
          fv->grad_ext_v[p] = 0.0;
        }
     ...
     *  grad( n ) .  Level set or shell normal vector gradient 
     */
    if (pd->v[imtrx][NORMAL1] || pd->v[imtrx][SHELL_NORMAL1])
      {
        if (pd->v[imtrx][NORMAL1]) v = NORMAL1;
        if (pd->v[imtrx][SHELL_NORMAL1]) v = SHELL_NORMAL1;
        dofs = ei[imtrx]->dof[v];
        for (p = 0; p < VIM; p++)
          {
            for (q = 0; q < VIM; q++)
    ...
    else if ( (zero_unused_grads && upd->vp[imtrx][NORMAL1] == -1) || upd->vp[imtrx][SHELL_NORMAL1] == -1)
      {
        for(p = 0; p < VIM; p++ )
          {
            for (q = 0; q < VIM; q++ )
     ...
     * grad(E_field), Electric field gradients.
     */  
    if (pd->v[imtrx][EFIELD1])
      {
        dofs = ei[imtrx]->dof[EFIELD1];
        v = EFIELD1;
      ...
      } else if (zero_unused_grads && upd->vp[imtrx][EFIELD1] != -1 )  {
      for ( p=0; p<VIM; p++)
	{
	  for ( q=0; q<VIM; q++)
	    {
    ...
    if( pd->v[imtrx][MASS_FRACTION] )
      ...
      } else if (zero_unused_grads && upd->vp[imtrx][MASS_FRACTION] == -1) {
      for ( w=0; w<pd->Num_Species_Eqn; w++)
        {			  
          for ( p=0; p<VIM; p++ )
            {
    ...
    if ( pd->v[imtrx][POR_LIQ_PRES] )
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][POR_LIQ_PRES] == -1 ) {
      for ( p=0; p<VIM; p++ )
        {
          fv->grad_p_liq[p] = 0.0;
          fv_old->grad_p_liq[p] = 0.0;
    ...
    if ( pd->v[imtrx][POR_GAS_PRES] )
      ...
      } else if (zero_unused_grads &&  upd->vp[imtrx][POR_GAS_PRES] == -1 ) {
      for ( p=0; p<VIM; p++ )
        {
          fv->grad_p_gas[p] = 0.0;
          fv_old->grad_p_gas[p] = 0.0;
    ...
    else if (zero_unused_grads &&  upd->vp[imtrx][POR_POROSITY] == -1) 
      {
        for (p = 0; p < VIM; p++ )
          {
            fv->grad_porosity[p] = 0.0;
    ...
    if (pd->v[imtrx][POLYMER_STRESS11])
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][POLYMER_STRESS11] == -1 )  {  
      for ( mode=0; mode<vn->modes; mode++)
        {
          for ( p=0; p<VIM; p++)
            {
    ...
    if ( pd->v[imtrx][VELOCITY_GRADIENT11] )
      ...
      } else if ( zero_unused_grads &&  upd->vp[imtrx][VELOCITY_GRADIENT11] == -1 ) {  
      for ( p=0; p<VIM; p++)
        {
          fv->div_G[p] = 0.0;
          fv->div_Gt[p] = 0.0;
    ...
    if (pd->v[imtrx][VORT_DIR1])
      ...
      } else if (zero_unused_grads &&  upd->vp[imtrx][VORT_DIR1] == -1 ) {
      for (p=0; p<DIM; p++)
	{
          for (q=0; q<DIM; q++)
	    {
    ...
    if (pd->v[imtrx][N_DOT_CURL_V])
      ...
      } else if (zero_unused_grads &&  upd->vp[imtrx][N_DOT_CURL_V] == -1 ) {
      for (p = 0; p < VIM; p++) {
	fv->grad_n_dot_curl_s_v[p] = 0.0;
      }
    }
     ...
     *        The scalar field is the surface divergence of the velocity
     */
    if (pd->v[imtrx][SHELL_SURF_DIV_V])
      {
        v = SHELL_SURF_DIV_V;
        bfn = bf[v];
        dofs = ei[imtrx]->dof[v];
      ...
      } else if (zero_unused_grads &&  upd->vp[imtrx][SHELL_SURF_DIV_V] == -1 ) {
      for (p = 0; p < VIM; p++) {
	fv->grad_div_s_v[p] = 0.0;
      }
    }
    ...
    if (pd->v[imtrx][SHELL_SURF_CURV])
      ...
      } else if (zero_unused_grads &&  upd->vp[imtrx][SHELL_SURF_CURV] == -1) {
      for (p = 0; p < VIM; p++) {
	fv->grad_curv[p] = 0.0;
      }
    }
    ...
    else  if (zero_unused_grads &&  upd->vp[imtrx][GRAD_S_V_DOT_N1] == -1 ) 
      {
        for (r = 0; r < dim; r++) 
          {
            for (p = 0; p < VIM; p++) {
    ...
    else if ( zero_unused_grads &&  upd->vp[imtrx][SHELL_DIFF_FLUX] == -1 ){
      for (p=0; p<VIM; p++) fv->grad_sh_J[p] = 0.0;
    }
    ...
    if ( pd->v[imtrx][ACOUS_PREAL] )
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][ACOUS_PREAL] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_apr[p] = 0.0;
    }
    ...
    if ( pd->v[imtrx][ACOUS_PIMAG] )
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][ACOUS_PIMAG] == -1 ){
      for (p=0; p<VIM; p++) fv->grad_api[p] = 0.0;
    }
    ...
    if ( pd->v[imtrx][ACOUS_REYN_STRESS] )
      {
        v = ACOUS_REYN_STRESS;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][ACOUS_REYN_STRESS] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_ars[p] = 0.0;
    }
  
    if ( pd->v[imtrx][SHELL_BDYVELO] )
      {
        v = SHELL_BDYVELO;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_BDYVELO] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_bv[p] = 0.0;
    }
  
    if ( pd->v[imtrx][SHELL_LUBP] )
      {
        v = SHELL_LUBP;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_LUBP] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_p[p] = 0.0;
    }
    ...
    else if ( zero_unused_grads && upd->vp[imtrx][LUBP] == -1 ) 
      {
        for (p=0; p<VIM; p++) fv->grad_lubp[p] = 0.0;
      }

    if ( pd->v[imtrx][LUBP_2])
      {
        v = LUBP_2;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
    ...
    else if ( zero_unused_grads && upd->vp[imtrx][LUBP_2] == -1 ) 
      {
        for (p=0; p<VIM; p++) fv->grad_lubp_2[p] = 0.0;
      }
  
    if ( pd->v[imtrx][SHELL_LUB_CURV] )
      {
        v = SHELL_LUB_CURV;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_LUB_CURV] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_l_curv[p] = 0.0;
    }

    if ( pd->v[imtrx][SHELL_LUB_CURV_2] )
      {
        v = SHELL_LUB_CURV_2;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_LUB_CURV_2] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_l_curv_2[p] = 0.0;
    }

    if ( pd->v[imtrx][SHELL_PRESS_OPEN] )
      {
        v = SHELL_PRESS_OPEN;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
    ...
    else if ( zero_unused_grads && upd->vp[imtrx][SHELL_PRESS_OPEN] == -1 ) 
      {
        for (p=0; p<VIM; p++) fv->grad_sh_p_open[p] = 0.0;
      }

    if ( pd->v[imtrx][SHELL_PRESS_OPEN_2] )
      {
        v = SHELL_PRESS_OPEN_2;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
    ...
    else if ( zero_unused_grads && upd->vp[imtrx][SHELL_PRESS_OPEN_2] == -1 ) 
      {
        for (p=0; p<VIM; p++) fv->grad_sh_p_open_2[p] = 0.0;
      }
  
  
    if ( pd->v[imtrx][SHELL_FILMP] )
      {
        v = SHELL_FILMP;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_FILMP] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_fp[p] = fv_old->grad_sh_fp[p] = 0.0;
    }
  
    if ( pd->v[imtrx][SHELL_FILMH] )
      {
        v = SHELL_FILMH;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_FILMH] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_fh[p] = fv_old->grad_sh_fh[p] = 0.0;
    }
    ...
    if ( pd->v[imtrx][SHELL_PARTC] )
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_PARTC] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_pc[p] = 0.0;
    } 

    if ( pd->v[imtrx][SHELL_TEMPERATURE] )
      {
        v = SHELL_TEMPERATURE;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][SHELL_TEMPERATURE] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_sh_t[p] = 0.0;
    } 

    if ( pd->v[imtrx][LIGHT_INTP] )
      {
        v = LIGHT_INTP;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][LIGHT_INTP] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_poynt[0][p] = 0.0;
    } 

    if ( pd->v[imtrx][LIGHT_INTM] )
      {
        v = LIGHT_INTM;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][LIGHT_INTM] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_poynt[1][p] = 0.0;
    } 


    if ( pd->v[imtrx][LIGHT_INTD] )
      {
        v = LIGHT_INTD;
        dofs  = ei[imtrx]->dof[v];
        for ( p=0; p<VIM; p++)
      ...
      } else if ( zero_unused_grads && upd->vp[imtrx][LIGHT_INTD] == -1 ) {
      for (p=0; p<VIM; p++) fv->grad_poynt[2][p] = 0.0;
    } 
...
#ifdef DEBUG_HKM
  if ((pd->v[pg->imtrx][SHELL_NORMAL1] == 0) && ei[pg->imtrx]->dof[SHELL_NORMAL1] > 0) {
    doExtra = 1;
  }
#endif
...
if ( pd->v[pg->imtrx][SHELL_LUB_CURV_2] )
  ...
  if (ei[pg->imtrx]->dof[SHELL_DIFF_FLUX] > 0)
    {
      v = SHELL_DIFF_FLUX;
      bfv = bf[v];
#ifdef DO_NOT_UNROLL
