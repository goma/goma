  ...
  */
  ...
  if (hunt[iHC].EndParameterValue == hunt[iHC].BegParameterValue) {
    ...
    if (hunt[iHC].ramp == 2) {
      ...
      dhunt_par_min =
          log10(1.0 + aldALC[iHC] * hunt[iHC].Delta_s_min / hunt[iHC].BegParameterValue) /
          (log10(hunt[iHC].EndParameterValue) - log10(hunt[iHC].BegParameterValue));
      dhunt_par_max =
          log10(1.0 + aldALC[iHC] * hunt[iHC].Delta_s_max / hunt[iHC].BegParameterValue) /
          (log10(hunt[iHC].EndParameterValue) - log10(hunt[iHC].BegParameterValue));
  ...
  for (n = 0; n < MaxPathSteps; n++) {
    ...
    for (iHC = 0; iHC < nHC; iHC++) {
      if (hunt[iHC].ramp == 2) {
        ...
        delta_s[iHC] = dhunt_par * (hunt[iHC].EndParameterValue - hunt[iHC].BegParameterValue);
      }
    }
    ...
    for (iHC = 0; iHC < nHC; iHC++) {
      if (hunt[iHC].ramp == 2) {
        ...
        path[iHC] =
            hunt[iHC].BegParameterValue +
            (hunt_par - dhunt_par) * (hunt[iHC].EndParameterValue - hunt[iHC].BegParameterValue);
      }
    }
    /*
     * ADJUST NATURAL PARAMETER
