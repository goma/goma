  ...
  if (elc_ptr->thermal_expansion_model == CONSTANT) {
    *thermexp = elc_ptr->thermal_expansion;
        ...
        *thermexp = elc_ptr->u_thermal_expansion[0] +
                ...
                tmp*(elc_ptr->u_thermal_expansion[2] +
                tmp*elc_ptr->u_thermal_expansion[3]));
        d_thermexp_dx[TEMPERATURE] = (elc_ptr->u_thermal_expansion[1] +
                tmp*(2.*elc_ptr->u_thermal_expansion[2] +
                tmp*3.*elc->u_thermal_expansion[3]));
