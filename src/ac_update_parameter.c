...
/* Calls from ac_conti.c (nCC=0) */
  if (nCC == 0) {
    ...
    else GOMA_EH(GOMA_ERROR, "Bad continuation type!");
  }
...
/* Calls from LOCA */
   ...
   */
    ...
    if (cont->upType != 6) GOMA_EH(GOMA_ERROR, "Bad continuation type!");
  }
 }
		   ...
		   Dpi *dpi)	  /* distributed processing information */
{
   ...
   */
    ...
    if (loca_in->TPupType != 6) GOMA_EH(GOMA_ERROR, "Bad TP continuation type!");
  }
}
		   ...
		   Dpi *dpi)	 /* distributed processing information */
{
  ...
  else GOMA_EH(GOMA_ERROR, "Bad HC continuation type!");
		  ...
		  Dpi *dpi)	 /* distributed processing information */
{
  ...
  else GOMA_EH(GOMA_ERROR, "Bad sens. parameter type!");
