...
def parse_args():
    ...
    parser.add_argument('--x0', type=float, default=0.0, help='X-coordinate of the origin')
    parser.add_argument('--y0', type=float, default=0.0, help='Y-coordinate of the origin')
    parser.add_argument('--z0', type=float, default=0.0, help='Z-coordinate of the origin')
    ...
    parser.add_argument('--dim', type=int, default=2, help='Dimension of the image choose 3 for shell')
    return parser.parse_args()

def image_to_vox(inname, outname, x0, y0, z0, resx, resy, resz, dim, black_val, white_val):
...
if __name__ == "__main__":
    args = parse_args()
    image_to_vox(args.IMAGE, args.VOXEL_OUTPUT, args.x0, args.y0, args.z0, args.resx, args.resy, args.resz, args.dim, args.BLACK_VALUE, args.WHITE_VALUE)
