...
//			    advection += v_rel[a] * fv->d_grad_F_dmesh[a][b][j] * phi_i;
    	  ...
    	  if (gn->ConstitutiveEquation == BINGHAM){
	          ...
	          switch(Fill_Weight_Fcn)
		       ...
		       for (a = 0; a < dim; a++) {
		         ...
		         {
		        	 advection += LubAux->dv_avg_dp1[a][j] * grad_II_F[a] * wfcn ;
		         }
	  ...
	  /*************************************************************
	   *
	   * Derivatives of fill equation w.r.t. to TOP WALL SHEAR RATE variable
	   *
	   *************************************************************/
		  ...
		  for( j=0; j < ei[pg->imtrx]->dof[var]; j++)
		  {
			  ...
			  case FILL_WEIGHT_G:  /* Plain ol' Galerkin */
				  for (a = 0; a < dim; a++) {
					  if (gn->ConstitutiveEquation == BINGHAM)
					  {
						  advection += LubAux->dv_avg_dshear_top[a][j] * grad_II_F[a] * wfcn ;
					  }
				  }
				  break;
			  }
	  ...
	  /*************************************************************
	   *
	   * Derivatives of fill equation w.r.t. to BOTTOM WALL SHEAR RATE variable
	   *
	   *************************************************************/
		  ...
		  for( j=0; j < ei[pg->imtrx]->dof[var]; j++)
		  {
			  ...
			  case FILL_WEIGHT_G:  /* Plain ol' Galerkin */
				  for (a = 0; a < dim; a++) {
					  if (gn->ConstitutiveEquation == BINGHAM)
					  {
						  advection += LubAux->dv_avg_dshear_bot[a][j] * grad_II_F[a] * wfcn ;
					  }
				  }
				  break;
			  }
	  ...
	  /*************************************************************
	   *
	   * Derivatives of fill equation w.r.t. to CROSS STREAM SHEAR STRESS variable
	   *
	   *************************************************************/
		  ...
		  for( j=0; j < ei[pg->imtrx]->dof[var]; j++)
		  {
			  ...
			  case FILL_WEIGHT_G:  /* Plain ol' Galerkin */
				  for (a = 0; a < dim; a++) {
					  if (gn->ConstitutiveEquation == BINGHAM)
					  {
						  advection += LubAux->dv_avg_dcross_shear[a][j] * grad_II_F[a] * wfcn ;
					  }
