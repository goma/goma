...
ve:
	cd src && ${MAKE} TARGET=goma_ve "DEFINES = -Dlinux -DCOMPILER_64BIT -DENABLE_AMESOS -DTRILINOS -DCHECK_FINITE -DMDE=27 -DMAX_PROB_VAR=28 -DMAX_EXTERNAL_FIELD=6 -DMAX_CONC=8 -DCOUPLED_FILL -DPARALLEL -DHAVE_STRATIMIKOS -DEIGEN_SERIAL -DPHASE_COUPLED_FILL -DNEW_HOFFMAN_FCN_PLEASE -DALE_DCA_INFO_PLEASE -DRELAX_ON_TRANSIENT_PLEASE -DRESET_TRANSIENT_RELAXATION_PLEASE  -DALLOW_NEGATIVE_TIMES_PLEASE  -DDM_COORD_SCALE_PLEASE -DVAR_UPDATE_UNITY_SCALE"
